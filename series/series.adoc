...
** <<24-spatial-information,2.4 Spatial Information>>
*** <<241-geoshape,2.4.1 GeoShape>>
*** <<242-geoshape,2.4.2 GeoCoordinates>>
...
The main https://schema.org/GeoShape[GeoShape] properties are given in <<table_object_geoshape>>.
