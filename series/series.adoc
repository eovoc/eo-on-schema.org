...
The encoding proposed using schema:Action in <<47-acquisition-information,4.7 Acquisition Information>> is only applicable to Collections and Granules.  For services and applications, Acquisition Information can be encoded as DefinedTerm from the platform and instrument thesaurus as in <<441-definedterm,4.4.1 DefinedTerm>>
...
Recommendation added to use ROR identifiers for organisations.    |Updated version for EOVOC PM-1 Meeting.
|====================
