...
~$.acquisitionInformation[*].platform~     | eop:platform      |         schema:platform  +
                                                                    (schema:AcquisitionInformation)   |   <<76-acquisition-information,7.6 Acquisition Information>> (Extension)
...
a| startWavelengths +
~$..wavelengths[*].startWavelength~     | eop:startWavelength      |     https://schema.org/minValue[$..wavelengths[*].maxValue]        |  <<763-wavelength-information,7.6.3 Wavelength Information>>  (Extension)

a| WavelengthInformation     |   eop:WavelengthInformation      |      schema:WavelengthInformation      |     (Extension)

a| wavelengths +
~$..acquisitionParameters.wavelengths~     | eop:wavelengths      |     schema:wavelengths +
                                                                      (schema:AcquisitionParameters)      |  <<764-acquisition-parameters,7.6.4 Acquisition Parameters>>  (Extension)
