...
~$.properties.contactpoint[*]~               | vcard:Kind |       https://schema.org/Person \| +
                                                                  https://schema.org/Organization |     <<table_role_responsible_party>>
								  
								  
a| Agent +
~$.properties.authors[*]~                   | foaf:Agent |       https://schema.org/Person \| +
                                                                  https://schema.org/Organization |     <<table_role_responsible_party>>
...
~$.properties.contactPoint~   | dcat:contactPoint |          https://schema.org/provider[$.provider] \|
                                                             https://schema.org/roleName[$.contributor.roleName] |    <<table_role_responsible_party>> and  <<table_object_contact>>
...
a| description +
~$..acquisitionInformation[].instrument.description~       | dct:description |     https://schema.org/description[$.potentialAction[\].instrument[\].description ]    |  <<table_object_acquisitioninformation>>
...
a| Individual +
~$.properties.authors[*]~     | foaf:Person |          https://schema.org/Person[Person]   |   <<table_object_contact>>, https://schema.org/Person[Person]
