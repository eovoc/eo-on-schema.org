...
~$..acquisitionParameters.completionTime FromAscendingNode~     | eop:completionTime FromAscendingNode      |    schema:acquisitionParameters/ schema:completionTime FromAscendingNode (Extension)         | <<764-acquisition-parameters,7.6.4 Acquisition Parameters>>
