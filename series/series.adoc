...
a| AcquisitionInformation +
     | eop:AcquisitionInformation      |    schema:AcquisitionInformation (Extension)         | 
...
a| AcquisitionParameters +
                                      | eop:AcquisitionParameters      |    schema:AcquisitionParameters (Extension)     | 
...
a| bbox +
~$.bbox~     | gj:bbox      |    https://schema.org/spatialCoverage[schema:spatialCoverage]/ https://schema.org/geo[schema:geo]/ https://schema.org/box[schema:box]         | 

a| beginningDateTime +
~$..acquisitionParameters.beginningDateTime~     | dcat:startDate      |    https://schema.org/temporalCoverage[schema:temporalCoverage]         | 
...
a| endingDateTime +
~$..acquisitionParameters.endingDateTime~     | dcat:endDate      |    https://schema.org/temporalCoverage[schema:temporalCoverage]         | 
...
a| identifier +
~$.properties.identifier~   | dct:identifier |          https://schema.org/identifier[schema:identifier] |  
