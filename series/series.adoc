...
** <<descriptive-keywords,2.3 Descriptive Keywords>>
* <<property-mapping,B. Property Mapping>>
* <<references,C. References>>
** <<normative-references,C.1 Normative References>>
** <<other-references,C.2 Other References>>
...
a| keywords +
~$.keywords~
| Free keywords not belonging to a controlled vocabulary related to the resource.  Multiple entries in a keywords list are typically delimited by commas.
| Domain: CreativeWork
