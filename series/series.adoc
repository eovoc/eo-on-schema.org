...
~$..acquisitionInformation.acquisitionParameters~     | eop:acquisitionParameters      |    schema:acquisitionInformation/<br />schema:acquisitionparameters (Extension)         |  
...
a| instrumentShortName +
~$..instrument.instrumentShortName~    | eop:instrumentShortName   |   https://schema.org/name[$.acquisitionInformation.sensor.name]    |  <<76-acquisition-information,7.6 Acquisition Information>> (Extension)
