...
a| acquisitionInformation +
~$.properties.acquisitionInformation~     | eop:acquisitionInformation      |    schema:acquisitionInformation (Extension)         |  
...
a| parentIdentifier +
~$.properties.parentIdentifier~     | eop:parentIdentifier |         https://schema.org/isPartOf[$.isPartOf]        |    N/A
...
a| status +
~$.properties.status~ |   eop:status      |      schema:acquisitionStatus   +
                                      [Domain: schema:EarthObservation]  |     (Extension)
