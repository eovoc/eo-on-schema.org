...
a| conformsTo +
~$.properties.conformsTo~   | dct:conformsTo |     schema:publishingPrinciples[$schema:publishingPrinciples]     |     TBD +
...
$.publishingPrinciples added to encode $.conformsTo. | Updated version for TBD.
