...
** <<normative-references,2.1 Normative references>>
** <<other-references,2.2 Other references>>

* <<terms-and-definitions,3. Terms and definitions>>

* <<4-eo-collections-encoding,4. EO Collections encoding>>
** <<metadata-information,4.1 Metadata Information>>
** <<data-identification,4.2 Data Identification>>
*** <<resource-dates,4.2.1 Resource Dates>>
*** <<propertyvalue,4.2.2 PropertyValue>>
*** <<contact,4.2.3 Contact>>
*** <<organization,4.2.4 Organization>>
*** <<person,4.2.5 Person>>
*** <<role,4.2.6 Role>>
** <<resource-constraints,4.3 Resource Constraints>>
** <<descriptive-keywords,4.4 Descriptive Keywords>>
*** <<definedterm,4.4.1 DefinedTerm>>
** <<spatial-information,4.5 Spatial Information>>
*** <<geoshape,4.5.1 GeoShape>>
*** <<geocoordinates,2.5.2 GeoCoordinates>>
** <<related-url,4.6 Related URL>>
*** <<mediaobject,4.6.1 MediaObject>>
*** <<action,4.6.2 Action>>
** <<acquisition-information,4.7 Acquisition Information>>
* <<eo-services-and-applications,5. EO Services and Applications>>
** <<service-identification,5.1 Service Identification>>
* <<eo-granules,6. EO Granules Encoding>>
...
[source,json]
----
include::../series/examples/landsat-etm-gtc.json.json[]
----

endif::[]

=== D.2 Service and Application

// Links for GitHub
ifdef::env-github,backend-html5[]

:exampledir: https://raw.githubusercontent.com/eovoc/eo-on-schema.org/main/series/examples

* https://github.com/eovoc/eo-on-schema.org/blob/main/series/examples/goce-user-toolbox.json[Example 1: GOCE User Toolbox]
...
[source,json]
----
include::../series/examples/goce-user-toolbox.json[]
----
