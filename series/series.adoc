...
** <<appendix-d1-collection,D.1: Collection>>
** <<appendix-d2-service-and-application,D.2: Service and Application>>
** <<appendix-d3-granule,D.3: Granule>>
