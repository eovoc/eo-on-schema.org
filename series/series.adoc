...
a| issued +
~$.properties.wasUsedBy[*].qualifiedAssociation.hadPlan.wasDerivedFrom.issued~   | dct:issued |      |  
...
a| lang +
~$.properties.links.*[*].lang~        | dct:language |                |    

a| length +
~$.properties.links.*[*].length~        | atom:length |                |   
