...
a| bbox +
~$.bbox~     | gj:bbox      |    schema:spatialCoverage/ schema:geo/ schema:box         | 

a| beginningDateTime +
~$..acquisitionParameters.beginningDateTime~     | dcat:startDate      |    schema:temporalCoverage         | 
...
a| platformSerialIdentifier +
~$..platform.platformSerialIdentifier~    | eop:platformSerialIdentifier   |   schema:acquisitionInformation/ schema:platform/ schema:serialNumber]    |  <<761-platform,7.6.1 Platform>>
