...
The corresponding example shape graph is available at https://github.com/eovoc/eo-on-schema.org/blob/main/series/docs/shacl-nodeshapes-collections.ttl[shacl-nodeshapes-collections.ttl]
