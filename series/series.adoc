...
GeoSPARQL interfaces may be used to query RDF stores providing triples encoded using schema.org.  The relation between the schema.org classes and properties and GeoSPARQL 1.1 are depicted in the diagram below which is based on https://opengeospatial.github.io/ogc-geosparql/geosparql11/spec.html#_e_7_schema_org.
