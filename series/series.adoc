...
a| acquisitionAngles +
~$..acquisitionParameters.acquisitionAngles~     | eop:acquisitionAngles      |    schema:acquisitionParameters/ schema:acquisitionAngles (Extension)         |
...
~$..acquisitionParameters.acquisitionStation~     | eop:acquisitionStation      |    schema:acquisitionParameters/ schema:acquisitionStation (Extension)         |



a| acquisitionSubType +
~$..acquisitionParameters.acquisitionSubType~     | eop:acquisitionSubType      |    schema:acquisitionParameters/ schema:acquisitionSubType (Extension)         |

a| acquisitionType +
~$..acquisitionParameters.acquisitionType~     | eop:acquisitionType      |    schema:acquisitionParameters/ schema:acquisitionType (Extension)         |


a| acrossTrackIncidenceAngle +
~$..acquisitionAngles.acrossTrackIncidenceAngle~    | eop:acrossTrackIncidenceAngle   |  schema:acquisitionInformation/ schema:acquisitionParameters/ schema:acquisitionAngles/ schema:acrossTrackIncidenceAngle (Extension)    | 

a| alongTrackIncidenceAngle +
~$..acquisitionAngles.alongTrackIncidenceAngle~    | eop:alongTrackIncidenceAngle   |  schema:acquisitionInformation/ schema:acquisitionParameters/ schema:acquisitionAngles/ schema:alongTrackIncidenceAngle (Extension)    | 

a| antennaLookDirection +
~$..acquisitionParameters.antennaLookDirection~     | eop:antennaLookDirection     |    schema:acquisitionParameters/ schema:antennaLookDirection (Extension)         |
...
~$..acquisitionParameters.completionTimeFromAscendingNode~     | eop:completionTimeFromAscendingNode      |    schema:acquisitionParameters/ schema:completionTimeFromAscendingNode (Extension)         |

a| cycleNumber +
~$..acquisitionParameters.cycleNumber~     | eop:cycleNumber     |    schema:acquisitionParameters/ schema:cycleNumber (Extension)         |
...
~$..wavelengths[*].discreteWavelengths~     | eop:discreteWavelength      |     schema:acquisitionParameters/ schema:wavelengths/ https://schema.org/value[schema:value]   |  <<763-wavelength-information,7.6.3 Wavelength Information>>  (Extension)
...
~$..acquisitionParameters.groundTrackUncertainty~     | eop:groundTrackUncertainty     |    schema:acquisitionParameters/ schema:groundTrackUncertainty (Extension)         |
...
~$..acquisitionAngles.illuminationAzimuthAngle~    | eop:illuminationAzimuthAngle   |  schema:acquisitionInformation/ schema:acquisitionParameters/ schema:acquisitionAngles/ schema:illuminationAzimuthAngle (Extension)    |  

a| illuminationElevationAngle +
~$..acquisitionAngles.illuminationElevationAngle~    | eop:illuminationElevationAngle   |  schema:acquisitionInformation/ schema:acquisitionParameters/ schema:acquisitionAngles/ schema:illuminationElevationAngle (Extension)    |  

a| illuminationZenithAngle +
~$..acquisitionAngles.illuminationZenithAngle~    | eop:instrumentZenithAngle   |  schema:acquisitionInformation/ schema:acquisitionParameters/ schema:acquisitionAngles/ schema:illuminationZenithAngle (Extension)    |  

a| incidenceAngleVariation +
~$..acquisitionAngles.incidenceAngleVariation~    | eop:incidenceAngleVariation   |  schema:acquisitionInformation/ schema:acquisitionParameters/ schema:acquisitionAngles/ schema:incidenceAngleVariation (Extension)    |  
...
a| instrumentShortName +
~$..instrument.instrumentShortName~    | eop:instrumentShortName   |  schema:acquisitionInformation/ schema:sensor/ https://schema.org/name[schema:name]    |  <<76-acquisition-information,7.6 Acquisition Information>> (Extension)

a| instrumentAzimuthAngle +
~$..acquisitionAngles.instrumentAzimuthAngle~    | eop:instrumentAzimuthAngle   |  schema:acquisitionInformation/ schema:acquisitionParameters/ schema:acquisitionAngles/ schema:instrumentAzimuthAngle (Extension)    |  

a| instrumentElevationAngle +
~$..acquisitionAngles.instrumentElevationAngle~    | eop:instrumentElevationAngle   |  schema:acquisitionInformation/ schema:acquisitionParameters/ schema:acquisitionAngles/ schema:instrumentElevationAngle (Extension)    |  

a| instrumentZenithAngle +
~$..acquisitionAngles.instrumentZenithAngle~    | eop:instrumentZenithAngle   |  schema:acquisitionInformation/ schema:acquisitionParameters/ schema:acquisitionAngles/ schema:instrumentZenithAngle (Extension)    |  
...
a| operationalMode +
~$..acquisitionParameters.operationalMode~     | eop:operationalMode      |    schema:acquisitionParameters/ schema:operationalMode (Extension)         |
...
a| pitch +
~$..acquisitionAngles.pitch~    | eop:pitch   |  schema:acquisitionInformation/ schema:acquisitionParameters/ schema:acquisitionAngles/ schema:pitch (Extension)    |
...
~$..acquisitionParameters.relativeOrbitNumber~     | eop:relativeOrbitNumber      |    schema:acquisitionParameters/ schema:relativeOrbitNumber (Extension)         |

a| roll +
~$..acquisitionAngles.roll~    | eop:roll   |  schema:acquisitionInformation/ schema:acquisitionParameters/ schema:acquisitionAngles/ schema:roll (Extension)    |

a| instrument +
~$.acquisitionInformation[*].instrument~     | eop:instrument      |    schema:acquisitionInformation/ schema:sensor (Extension)  | <<76-acquisition-information,7.6 Acquisition Information>>
...
~$..acquisitionParameters.startTimeFromAscendingNode~     | eop:startTimeFromAscendingNode      |    schema:acquisitionParameters/ schema:startTimeFromAscendingNode (Extension)         |
...
a| tileId +
~$..acquisitionParameters.tileId~     | eop:tileId     |    schema:acquisitionParameters/ schema:tileId (Extension)         |
...
a| wrsLatitudeGrid +
~$..acquisitionParameters.wrsLatitudeGrid~     | eop:wrsLatitudeGrid  |    schema:acquisitionParameters/ schema:wrsLatitudeGrid (Extension)         |

a| wrsLongitudeGrid +
~$..acquisitionParameters.wrsLongitudeGrid~     | eop:wrsLongitudeGrid     |    schema:acquisitionParameters/ schema:wrsLongitudeGrid (Extension)         |


a| yaw +
~$..acquisitionAngles.yaw~    | eop:yaw   |  schema:acquisitionInformation/ schema:acquisitionParameters/ schema:acquisitionAngles/ schema:yaw (Extension)    |
