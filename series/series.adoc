...
An `EarthObservation` represents an indoividual granule or product.
...
|September 30, 2021 |Y. Coene | 0.4 |  - Added UseAction example representing WCS offering in new Related URL and Actions sections  +
for EO Service. +
...
- Added SHACL information in <<appendix-b-interpretation-as-w3c-json-ld,Appendix B: Interpretation as W3C JSON-LD>> | Updated version for TBD.
