...
a| highestLocation +
~$.properties.highestLocation~      |   N/A      |      schema:acquisitionParameters/ https://schema.org/maxValue[schema:maxValue] |  <<742-vertical-spatial-domain,7.4.2 Vertical Spatial Domain>>
