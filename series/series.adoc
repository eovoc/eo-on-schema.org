...
a| platform +
~$.acquisitionInformation[*].platform~     | eop:platform      |         schema:platform       |    <<76-acquisition-information,7.6 Acquisition Information>> (Extension)
...
a| wavelengths +
~$..acquisitionParameters.wavelengths~     | eop:wavelengths      |     https://wavelengths        |  <<764-acquisition-parameters,7.6.4 Acquisition Parameters>>  (Extension)
