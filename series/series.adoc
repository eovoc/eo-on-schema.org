...
a| instrument +
~$.acquisitionInformation[*].instrument~     | eop:instrument      |         schema:sensor       |    <<76-acquisition-information,7.6 Acquisition Information>> (Extension)
...
a| platformShortName +
~$..platform.platformShortName~    | eop:platformShortName   |   https://schema.org/name[$.acquisitionInformation.platform.name]    |  <<76-acquisition-information,7.6 Acquisition Information>> (Extension)
