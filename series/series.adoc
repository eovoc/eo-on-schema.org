...
~$..acquisitionInformation.acquisitionParameters~     | eop:acquisitionParameters      |    schema:acquisitionInformation/ schema:acquisitionparameters (Extension)         |  
...
~$..wavelengths[*].discreteWavelengths~     | eop:discreteWavelength      |     https://schema.org/value[$..wavelengths[*].value]        |  <<763-wavelength-information,7.6.3 Wavelength Information>>  (Extension)

a| endingDateTime +
~$..acquisitionParameters.endingDateTime~     | dcat:endDate      |    schema:temporalCoverage         | 

a| endWavelength +
~$..wavelengths[*].endWavelength~     | eop:endWavelength      |     https://schema.org/maxValue[$..wavelengths[*].maxValue]        |  <<763-wavelength-information,7.6.3 Wavelength Information>>  (Extension)
...
a| instrumentShortName +
~$..instrument.instrumentShortName~    | eop:instrumentShortName   |  schema:acquisitionInformation/ schema:sensor/ schema:name    |  <<76-acquisition-information,7.6 Acquisition Information>> (Extension)
...
a| parentIdentifier +
~$.properties.parentIdentifier~     | eop:parentIdentifier |         https://schema.org/isPartOf[$.isPartOf]   or schema:parentIdentifier     |   <<71-earth-observation,7.1 Earth Observation>>
...
a| platform +
~$.acquisitionInformation[*].platform~     | eop:platform      |    schema:acquisitionInformation/ schema:platform   |   <<76-acquisition-information,7.6 Acquisition Information>> (Extension)

a| Platform  | eop:Platform      |         schema:Platform (Extension)   |   <<761-platform,7.6.1 Platform>>

a| platformSerialIdentifier +
~$..platform.platformSerialIdentifier~    | eop:platformSerialIdentifier   |   schema:acquisitionInformation/ schema:platform/ schema:serialNumber]    |  <<76-acquisition-information,7.6 Acquisition Information>> (Extension)

a| platformShortName +
~$..platform.platformShortName~    | eop:platformShortName   |  schema:acquisitionInformation/  schema:platform/ schema:name  |  <<76-acquisition-information,7.6 Acquisition Information>> (Extension)
...
a| size +
~$.properties.productInformation.size~ |   eop:size      |     schema:productInformation/ schema:contentSize  |     (Extension)
				      
a| startTimeFromAscendingNode +
~$..acquisitionParameters.startTimeFromAscendingNode~     | eop:startTimeFromAscendingNode      |    schema:acquisitionParameters/ schemastartTimeFromAscendingNode (Extension)         |

a| startWavelengths +
~$..wavelengths[*].startWavelength~     | eop:startWavelength      |     https://schema.org/minValue[$..wavelengths[*].minValue]        |  <<763-wavelength-information,7.6.3 Wavelength Information>>  (Extension)

a| status +
~$.properties.status~ |   eop:status      |      schema:acquisitionStatus (Extension) |  <<71-earth-observation,7.1 Earth Observation>>
				      
a| TBDoperationalMode +
~$..acquisitionParameters.operationalMode~     | eop:operationalMode      |    schema:acquisitionParameters/ schema:operationalMode (Extension)         |
...
a| WavelengthInformation     |   eop:WavelengthInformation      |      schema:WavelengthInformation      |     (Extension)
