...
** <<53-descriptive-keywords,5.3 Descriptive Keywords>>
** <<54-related-url,5.4 Related URL>>
*** <<541-action,5.4.1 Action>>
** <<55-quality-information,5.5 Quality Information>>
* <<6-eo-granules-encoding,6. EO Granules Encoding>>
** <<61-granule-identification,6.1 Granule Identification>>
* <<7-eo-granules-encoding-extension,7. EO Granules Encoding (Extension)>>
** <<71-earth-observation,7.1 Earth Observation>>
** <<72-metadata-information,7.2 Metadata Information>>
** <<73-data-identification,7.3 Data Identification>>
** <<74-spatial-information,7.4 Spatial Information>>
*** <<741-horizontal-spatial-domain,7.4.1 Horizontal Spatial Domain>>
*** <<742-vertical-spatial-domain,7.4.2 Vertical Spatial Domain>>
*** <<743-orbit-parameters,7.4.3 Orbit Parameters>>
** <<75-temporal-information,7.5 Temporal Information>>
** <<76-acquisition-information,7.6 Acquisition Information>>
*** <<761-platform,7.6.1 Platform>>
*** <<762-instrument,7.6.2 Instrument>>
*** <<763-wavelength-information,7.6.3 Wavelength Information>>
*** <<764-acquisition-parameters,7.6.4 Acquisition Parameters>>
*** <<765-acquisition-angles,7.6.5 Acquisition Angles>>
** <<77-product-information,7.7 Product Information>>
*** <<771-quality-information,7.7.1 Quality Information>>
*** <<772-processing-information,7.7.2 Processing Information>>
*** <<773-coverage-description,7.7.3 Coverage Description>>
...
** <<ogc17-084r1-metadata,C.1: OGC17-084r1 Metadata>>
** <<ogc17-003r2-metadata,C.2: OGC17-003r2 Metadata>>
** <<stac-item-metadata,C.3: STAC Item Metadata>>
...
[[CEOS-OS-BP]][CEOS-OS-BP]::
	CEOS OpenSearch Best Practice Document, Version 1.3, https://ceos.org/document_management/Working_Groups/WGISS/Documents/WGISS%20Best%20Practices/CEOS%20OpenSearch%20Best%20Practice.pdf
[[JSONPath]][JSONPath]::
...
[[ESIPFed]][ESIPFed]::
	"Schema.org Publishing Guidelines for the Geosciences", V1.1.0, https://doi.org/10.5281/zenodo.3736235, https://github.com/ESIPFed/science-on-schema.org/releases/tag/1.1.0
[[DCAT-AP-SDO]][DCAT-AP-SDO]::
	DCAT-AP to Schema.org Mapping, Unofficial Draft 30 April 2021, https://ec-jrc.github.io/dcat-ap-to-schema-org/
...
[[WEBAPI]][WEBAPI]::
	Machine Readable Web APIs with Schema.org Action Annotations, Procedia Computer Science Volume 137, 2018, Pages 255-261, https://doi.org/10.1016/j.procs.2018.09.025.
[[SHAPEUML]][SHAPEUML]::
	ShapeUML: RDF Constraints Visualization based on UML, https://lov.ilabt.imec.be/unshacled/spec/shape-uml.
...
a| variableMeasured +
~$.variableMeasured~
| The variableMeasured property (pending) can indicate variables that are measured in the dataset, either described as text or as pairs of propertyID and name using PropertyValue.  See https://github.com/ESIPFed/science-on-schema.org/blob/master/guides/Dataset.md#variables[ESIPFed] for a detailed explanation. 
...
| Additional type of the keyword.  For a `skos:Concept`, the URI of a `skos:broader` concept can be used as well.  In the instrument example below, this property is used to represent the instrument type.
| Domain: DefinedTerm +
Range: URL 
| Zero or more (optional)
...
GeoSPARQL interfaces may be used to query RDF stores providing triples encoded using schema.org.  The relation between the schema.org classes and properties (green) and GeoSPARQL 1.1 (orange) are depicted in the diagram below which is based on https://opengeospatial.github.io/ogc-geosparql/geosparql11/spec.html#_e_7_schema_org.

[#img_object_geosparql,reftext='{figure-caption} {counter:figure-num}']
.GeoSPARQL schema
image::diagrams/Geometry.png[align="center"]

The example below searches for granules from the PROBA satellite over the location of Mount Etna and returns their identifier, temporal coverage and quicklook image.

.GeoSPARQL encoding example
[source]
----
PREFIX schema: <https://schema.org/>
PREFIX geo: <http://www.opengis.net/ont/geosparql#>

SELECT ?p ?id ?time ?preview
WHERE
{
...
[NOTE] 
The (pending) https://schema.org/LinkRole[LinkRole] class can represent URL with an IANA link registry relation via https://schema.org/linkRelationship[linkRelationship].  This class does not have a `contentType` property however, therefore `MediaObject` and `DataDownload` can be used instead.
...
a| url +
~$.url~
| URL of the resource, e.g. landing page for the collection.
| Range: URL
| Zero or more (optional)
...
a| additionalProperty +
~$.distribution[].additionalProperty~ +
~$.subjectOf[].additionalProperty~ +
~$.mentions[].additionalProperty~
| Reference coordinate system TBD See https://github.com/ESIPFed/science-on-schema.org/blob/master/guides/Dataset.md#spatial-coverage, typically used for granule downloads.
| Range: TBD
...
REST elements can be described using `Action` where the `object` property refers to the RESTFul resource (See also <<WEBAPI>>). 
...
[#img_object_linkrole,reftext='{figure-caption} {counter:figure-num}']
.LinkRole schema
image::diagrams/LinkRole.png[align="center"]
...
.LinkRole encoding example (Dataset)
[source,json]
----
{
	"@context": "https://schema.org",
	...
	"url": [
		{
			...
			"url": "https://earth.esa.int/eogateway/catalog/landsat-7-etm-enhanced-thematic-mapper-plus-geolocated-terrain-corrected-systematic-processing?text=landsat+tm+etm",
			"name": "Landing page",
			"linkRelationship": "describedby"
		},
		{
			"@type": "LinkRole",
			"url": "http://fedeo.esa.int/collections/series/items/LANDSAT.ETM.GTC?httpAccept=application/vnd.iso.19139-2%2Bxml",
			"name": "ISO 19139-2 metadata",
...
[#img_object_additionalinformation,reftext='{figure-caption} {counter:figure-num}']
.Additional Information schema
image::diagrams/AdditionalInformation.png[align="center"]
...
For collection or granule properties not available in schema.org, properties pointing to an external vocabulary, for example the JSON-LD property from the RDF Schema Vocabulary in Annex B.3 and Annex C of <<OGC17-003r2>> can be used. 

The https://schema.org/propertyID[`propertyID`] shall be of type URL and indicate the type of the property, by pointing to the external vocabulary, for instance <<OGC17-003r2>>, as shown below.

A list of PropertyValue properties of interest to be used in combination with `additionalProperty` is given in <<table_object_propertyvalue_additional_property>>.

[#table_object_propertyvalue_additional_property,reftext='{table-caption} {counter:table-num}']
...
| Type of the object. This property has the fixed value of "https://schema.org/PropertyValue[PropertyValue]".
| Range: String +
Fixed value: "PropertyValue" 
| One (mandatory)
...
| A URL indicating the type of the property, either pointing to an external vocabulary, or a Web resource that describes the property (e.g. a glossary entry). Standards bodies should promote a standard prefix for the identifiers of properties from their standards.  For Earth Observation specific properties, the vocabulary defined in <<OGC17-003r2>> can be used.  The vocabulary `http://www.opengis.net/ont/eo-geojson/1.0/` is available from OGC at http://schemas.opengis.net/eo-geojson/1.0/eo-geojson-vocabulary.owl and promotes as standard prefix `eop:`.
| Range: URL
| One (mandatory)
...
The schema below illustrates how the `eop:productType` and `eop:processingLevel` properties can be encoded using the above mechanism.

[#img_object_collection_method_1,reftext='{figure-caption} {counter:figure-num}']
.Dataset schema with additionalProperty 
image::diagrams/Method1-Collection.png[align="center"]


.Collection encoding example with additional EO properties
[source,json]
----
{
	"@context": "https://schema.org",
	...
	"@id": "https://eovoc.spacebel.be/collections/series/items/TropForest",
	"identifier": "TropForest",
	"name": "TropForest - ALOS, Deimos-1 & KOMPSAT-2 optical coverages over tropical forests",
	"additionalProperty": [
		{
			"@type": "PropertyValue",
			"propertyID": "http://www.opengis.net/ont/eo-geojson/1.0/productType",
			"value": ["AL1_AV2_2F", "DE1_SL6_2F", "KO2_MSC_2F"]
		},
		{
			"@type": "PropertyValue",
			"propertyID": "http://www.opengis.net/ont/eo-geojson/1.0/orbitType",
			"value": "Sun-synchronous"
		},
		{
			"@type": "PropertyValue",
			"propertyID": "http://www.opengis.net/ont/eo-geojson/1.0/resolution",
			"value": [5, 20]
		}
	]
}
...
`additionalType' can be used to identify the service type more precisely.  https://github.com/earthcubearchitecture-project418/p419dcatservices#wikidata-api-types[Project418] proposes using Wikidata API Types, but other identifiers can be used as well. 

.Service type encoding example
[source,json]
----
{
	"@context": {
	...
	"@type": "CreativeWork",
	"@id": "https://eovoc.spacebel.be/collections/services/items/eo-pdgs-landsat-datacube",
	"name": "Landsat DataCube"
	"additionalType": [	 
		"http://inspire.ec.europa.eu/metadata-codelist/ResourceType/service",
		"http://www.opengis.net/def/serviceType/ogc/wcs/2.0",
		"http://www.wikidata.org/entity/Q2000194"
		]
}
----
...
// 5.3 --------------------------------------------------------------------------------------------
ifdef::env-github[]
=== 5.3 Descriptive Keywords
endif::[]
ifndef::env-github[]
=== Descriptive Keywords
endif::[]

The encoding of for Descriptive Keywords was presented in <<44-descriptive-keywords,§4.4 Descriptive Keywords>> and also applies to services.  The example below shows how INSPIRE Spatial data service type and category can be encoded using Descriptive Keywords.

.Descriptive keywords encoding example (Service)
[source,json]
----
{
	"@context": "https://schema.org/",
	...
	"name": "Landsat DataCube",
   	"keywords": [
    		...
    		},
    		{
      			...
      			"@id": "http://inspire.ec.europa.eu/metadata-codelist/SpatialDataServiceType/download",
      			"inDefinedTermSet": "https://inspire.ec.europa.eu/metadata-codelist/SpatialDataServiceType"
    		},
		{
     		 	"@type": "DefinedTerm",
      			"name": "Spatial data service",
      			"@id": "http://inspire.ec.europa.eu/metadata-codelist/ResourceType/service",
      			"inDefinedTermSet": "http://inspire.ec.europa.eu/metadata-codelist/ResourceType"
    		},
    		{
     		 	"@type": "DefinedTerm",
...
Actions can be used to encode an OWC `offering` of a service record with multiple operations (See <<OGC14-055r2>>). The example below represents an offering corresponding to an OGC Web Coverage Service (WCS).  The service metadata record would use `potentialAction` to relate the service metadata record with the `Action`.   As the `Action` uses the service, it is encoded as a `UseAction`.  The property `object` provides information about coupled EO collections and is equivalent to the ISO19119 `operatesOn` relation.  


.UseAction encoding example (OGC WCS)
[source,json]
----
{
	"@context": "https://schema.org",
	...
	"object": {
			"@type": "Dataset",
			"@id": "https://eovoc.spacebel.be/collections/series/items/LANDSAT.ETM.GTC",
			"identifier": "LANDSAT.ETM.GTC"
		},
	"target": [
		{
			"@type": "EntryPoint",
			"identifier": "http://www.opengis.net/spec/owc-geojson/1.0/req/wcs#GetCapabilities",
			"contentType": [
				"text/xml"
			],
			"urlTemplate": "https://datacube.pdgs.eo.esa.int/wcs?service=WCS&Request=GetCapabilities&version=2.0.0",
			"description": "GetCapabilities",
			"httpMethod": "GET"
		},
		{
			"@type": "EntryPoint",
			"identifier": "http://www.opengis.net/spec/owc-geojson/1.0/req/wcs#DescribeCoverage",
			"contentType": [
				"text/xml"
			],
			"urlTemplate": "https://datacube.pdgs.eo.esa.int/wcs?service=WCS&Request=DescribeCoverage&version=2.0.0&CoverageId=LE7_RGB",
...
// 5.5 --------------------------------------------------------------------------------------------
ifdef::env-github[]
=== 5.5 Quality Information
endif::[]
ifndef::env-github[]
=== Quality Information
endif::[]

Quality information can include conformity to implementing rules or specifications.  `Review` and `Rating` may be used to encode such information.

.Conformance result encoding example
[source,json]
----
{
	"@context": "https://schema.org/",
	...
	"review": [
		{
			...
			"about": {
				...
				"dateCreated": "2010-12-08T00:00:00Z"
			},
			"reviewRating": {
				"@type": "Rating",
				"ratingValue": "http://inspire.ec.europa.eu/metadata-codelist/DegreeOfConformity/notEvaluated",
		...
		},
		{
			...
			"about": {
				"@type": "CreativeWork",
				"@id": "http://inspire.ec.europa.eu/id/ats/metadata/2.0/sds-invocable",
				"name": "INSPIRE Invocable Spatial Data Services metadata",
				"dateCreated": "2016-05-01T00:00:00Z"
			},
			"reviewRating": {
				"@type": "Rating",
				"ratingValue": "http://inspire.ec.europa.eu/metadata-codelist/DegreeOfConformity/notEvaluated",
...
// 7 --------------------------------------------------------------------------------------------
ifdef::env-github[]
== 7 EO Granules Encoding (Extension)
endif::[]
ifndef::env-github[]
== EO Granules Encoding (Extension)
endif::[]

This section proposes an EO extension of schema.org for encoding of Earth Observation granule metadata.  The extension consists of additional classes and properties which can be used instead of the corresponding classes and properties defined in <<OGC17-003r2>>.  Where no schema.org class or property was available, new classes or properties are proposed for schema.org, fitting in the class hierarchy and reusing the original <<OGC17-003r2>> names unless the name was already reserved for a different meaning (e.g; https://schema.org/instrument).  The formal definition of the extension is available as <<appendix-f-schemaorg-extension-for-eo,Appendix F: Schema.org Extension for EO>>.  The class inheritance hierarchy is presented in <<method-3---extending-schemaorg, Annex D.1.3: Extending schema.org>>.

The extension defines a number of subclasses of `Enumeration`.  The subclasses are depicted below with the corresponding enumeration members.

[#img_object_enumerations,reftext='{figure-caption} {counter:figure-num}']
.Enumeration Schema
image::diagrams/diagram-Enumerations.png[align="center"]

The graphical representations below are derived from the formal definition in Turtle format.    
The current section follows the same structure as chapter 7 of <<OGC17-003r2>> and has the same subsections.  

The examples included in the current chapter are available as .txt files in the format supported by the schema.org software for publishing examples as depicted below.

.Example text file for use with schema.org software
[source]
----
TYPES: WavelengthInformation, spectralRange
...
An `EarthObservation` represents an individual granule or product.

[#img_object_earthobservation,reftext='{figure-caption} {counter:figure-num}']
.EarthObservation Schema
image::diagrams/diagram-EarthObservation.png[align="center"]

.EarthObservation Shape
[source,turtle]
----
...
.EarthObservation encoding example
[source,json]
----
{
	"@context": "https://schema.org/",
	"@type": "EarthObservation",
	"@id": "https://eovoc.spacebel.be/collections/datasets/items/KO2_OTPF_KO2_MSC_2F_20091107T041750_20091107T041750_017498_E082_N028",
	"description": "Dataset KO2_OTPF_KO2_MSC_2F_20091107T041750_20091107T041750_017498_E082_N028 from TropForest acquired 2009-11-07T04:17:50Z",
	"identifier": ["KO2_OTPF_KO2_MSC_2F_20091107T041750_20091107T041750_017498_E082_N028"],
	"alternateName": "KO2_OTPF_KO2_MSC_2F_20091107T041750_20091107T041750_017498_E082_N028",
	"dateModified": "2021-06-18T13:59:11Z",

	"additionalType": "http://purl.org/dc/dcmitype/Dataset",
	"temporalCoverage": "2009-11-07T04:17:50Z/2009-11-07T04:17:50Z",
	"includedInDataCatalog": {
		"@type": "DataCatalog",
		"name": "FedEO Clearinghouse"
	},
	"isPartOf": "https://eovoc.spacebel.be/collections/series/items/TropForest",
	"spatialCoverage": {
		"geo": {
			"polygon": "28.08365828 81.91450641 27.91026471 81.91450641 27.91026471 82.10769379 28.08365828 82.10769379",
			"@type": "GeoShape",
			"box": "27.91026471 81.91450641 28.08365828 82.10769379"
		},
		"@type": "Place"
	},
	"distribution": [
	{
		"contentUrl": "http://tpm-ds.eo.esa.int/oads/meta/Tropforest/browse/KO2_OTPF_KO2_MSC_2F_20091107T041750_20091107T041750_017498_E082_N028.ZIP_BID.JPG",
		"@type": "DataDownload",
		"name": "QUICKLOOK",
		"encodingFormat": "image/jpeg"
	},
	{
		"contentUrl": "http://tpm-ds.eo.esa.int/oads/meta/Tropforest/thumbnail/KO2_OTPF_KO2_MSC_2F_20091107T041750_20091107T041750_017498_E082_N028.ZIP_TIMG.jpg",
		"@type": "DataDownload",
		"name": "THUMBNAIL",
		"encodingFormat": "image/jpeg"
	},
	{
		"contentUrl": "https://tpm-ds.eo.esa.int/oads/data/Tropforest/KO2_OTPF_KO2_MSC_2F_20091107T041750_20091107T041750_017498_E082_N028.ZIP",
		"@type": "DataDownload",
		"contentSize": "85503826",
		"name": "Download",
...
// 7.2 --------------------------------------------------------------------------------------------
ifdef::env-github[]
=== 7.2 Metadata Information
endif::[]
ifndef::env-github[]
=== Metadata Information
endif::[]

No extension is required.  The encoding presented in <<41-metadata-information,section 4.1 Metadata Information>> also applies for EO granules.


// 7.3 --------------------------------------------------------------------------------------------
ifdef::env-github[]
=== 7.3 Data Identification
endif::[]
ifndef::env-github[]
=== Data Identification
endif::[]
...
No extension is required.  The encoding presented in <<45-spatial-information,section 4.5 Spatial Information>> also applies for EO granules.
...
[#img_object_verticalspatialdomain,reftext='{figure-caption} {counter:figure-num}']
.VerticalSpatialDomain Schema
image::diagrams/diagram-VerticalSpatialDomain.png[align="center"]

.VerticalSpatialDomain Shape
[source,turtle]
----
...
.VerticalSpatialDomain encoding example
[source,json]
----
{
	"@context": "https://schema.org/",
...
[#img_object_orbitparameters,reftext='{figure-caption} {counter:figure-num}']
.OrbitParameters Schema
image::diagrams/diagram-OrbitParameters.png[align="center"]

.OrbitParameters Shape
[source,turtle]
----
...
.OrbitParameters encoding example
[source,json]
----
{
	"@context": "https://schema.org/",
...
image::diagrams/diagram-AcquisitionInformation.png[align="center"]
...
.AcquisitionInformation encoding example
[source,json]
----
{
	"@context": "https://schema.org/",
	...
	"platform": {
		...
		"@id": "http://gcmd.earthdata.nasa.gov/kms/concept/1bffe898-f4a2-458e-92c5-cd7c9c1cd5f0",
		"name": "Seasat",
		"serialNumber": "1"
	},
	"sensor": {
		...
		"@id":  "http://gcmd.earthdata.nasa.gov/kms/concept/a37282d4-322c-4dd0-8edc-36099b9b586c",
		"sensorType": "RADAR",
		"name": "SAR"            
	},
...
[#img_object_platform,reftext='{figure-caption} {counter:figure-num}']
.Platform Schema
image::diagrams/diagram-Platform.png[align="center"]
...
[#img_object_instrument,reftext='{figure-caption} {counter:figure-num}']
.Instrument Schema
image::diagrams/diagram-Instrument.png[align="center"]
...
[#img_object_wavelengthinformation,reftext='{figure-caption} {counter:figure-num}']
.WavelengthInformation Schema
image::diagrams/diagram-WavelengthInformation.png[align="center"]

.WavelengthInformation Shape
[source,turtle]
----
...
.WavelengthInformation encoding example
[source,json]
----
{
	"@context": "https://schema.org/",
...
[#img_object_acquisitionparameters,reftext='{figure-caption} {counter:figure-num}']
.AcquisitionParameters Schema
image::diagrams/diagram-AcquisitionParameters.png[align="center"]

.AcquisitionParameters Shape
[source,turtle]
----
...
.AcquisitionParameters encoding example
[source,json]
----
{
	"@context": "https://schema.org/",
...
[#img_object_acquisitionangles,reftext='{figure-caption} {counter:figure-num}']
.AcquisitionAngles Schema
image::diagrams/diagram-AcquisitionAngles.png[align="center"]

.AcquisitionAngles Shape
[source,turtle]
----
...
.AcquisitionAngles encoding example
[source,json]
----
{
	"@context": "https://schema.org/",
...
[#img_object_productinformation,reftext='{figure-caption} {counter:figure-num}']
.ProductInformation Schema
image::diagrams/diagram-ProductInformation.png[align="center"]

.ProductInformation Shape
[source,turtle]
----
eoshacl:EOProductInformationShape
	...
	sh:ignoredProperties ( rdf:type schema:cloudCover schema:snowCover schema:compositeType schema:processingMethod schema:processingMethodVersion schema:processingCenter schema:processingDate schema:processingLevel schema:processingMode  schema:processorName schema:softwareVersion schema:productContentsType ) ;
	...
	sh:property [
		sh:path schema:availabilityTime ;
	  	sh:minCount 0 ;
	  	sh:maxCount 1 ;
		sh:datatype xsd:string  # schema:DateTime ? 
	] ;
	sh:property [
...
.ProductInformation encoding example
[source,json]
----
{
	"@context": "https://schema.org/",
...
[#img_object_qualityinformation,reftext='{figure-caption} {counter:figure-num}']
.QualityInformation Schema
image::diagrams/diagram-QualityInformation.png[align="center"]

.QualityInformation Shape
[source,turtle]
----
eoshacl:EOPQualityInformationShape
	a sh:NodeShape ;
...
.QualityInformation encoding example
[source,json]
----
{
	"@context": "https://schema.org/",
	"@type": "QualityInformation",       
	
	"qualityDegradation": 75,
	"qualityStatus": "DEGRADED",
	"qualityDegradationQuotationMode": "AUTOMATIC",
	"qualityDegradationTag": "GEOLOCATION"
}
----
...
[#img_object_processinginformation,reftext='{figure-caption} {counter:figure-num}']
.ProcessingInformation Schema
image::diagrams/diagram-ProcessingInformation.png[align="center"]

.ProcessingInformation Shape
[source,turtle]
----
...
.ProcessingInformation encoding example
[source,json]
----
{
	"@context": "https://schema.org/",
...
[#img_object_coveragedescription,reftext='{figure-caption} {counter:figure-num}']
.CoverageDescription Schema
image::diagrams/diagram-CoverageDescription.png[align="center"]

.CoverageDescription Shape
[source,turtle]
----
...
.CoverageDescription encoding example
[source,json]
----
{
	"@context": "https://schema.org/",
...
When the EO Granule Encoding Extensions defined in <<7-eo-granules-encoding-extension,Chapter 7>> are used as well, then the corresponding context document is to be used in addition:

* https://github.com/eovoc/eo-on-schema.org/blob/main/series/docs/jsonldcontext-eo.json[jsonldcontext-eo.json]

They can be used to define the `@context` in data graphs as follows:

.JSON-LD @context encoding example
[source,json]
----
"@context": [
...
=== SHACL
The Shapes Constraint Language <<SHACL>> allows defining shape graphs to validate data graphs satisfying a set of conditions as expressed in this document.  The ShapeUML <<ShapeUML>> diagram below depicts a set of SHACL node shapes that correspond to the <<4-eo-collections-encoding, EO Collections encoding>>.

[#img_object_shaclnodeshapes,reftext='{figure-caption} {counter:figure-num}']
.SHACL node shapes for EO Collection Encoding
image::diagrams/shacl-nodeshapes-collections.png[align="center"]

The corresponding shape graphs are available at:

* https://github.com/eovoc/eo-on-schema.org/blob/main/series/shacl/shacl-collection.ttl[shacl-collection.ttl]
* https://github.com/eovoc/eo-on-schema.org/blob/main/series/shacl/shacl-granule.ttl[shacl-granule.ttl]
* https://github.com/eovoc/eo-on-schema.org/blob/main/series/shacl/shacl-granule-extension.ttl[shacl-granule-extension.ttl]
...
a| conformsTo +
~$.properties.conformsTo~   | dct:conformsTo |     https://schema.org/publishingPrinciples[$.publishingPrinciples]     |     <<table_object_dataset>> +
                                                                                                                       Proposed by <<DCAT-AP-SDO>>.
...
a| platform +
~$..acquisitionInformation[*].platform~   | prov:used |          schema:potentialAction/ schema:instrument/   |  <<table_object_acquisitioninformation>>
...
~$..platform.platformSerialIdentifier~   | eop:platformSerialIdentifier |          schema:potentialAction/ schema:instrument/ schema:serialNumber   |  <<table_object_acquisitioninformation>>



a| platformShortName +
~$..platform.platformShortName~   | eop:platformShortName |          schema:potentialAction/ schema:instrument/ schema:name   |  <<table_object_acquisitioninformation>>

a| platformShortName +
~$..platform.platformShortName~   | eop:platformShortName |  schema:acquisitionInformation/ schema:platform/ schema:name  |  <<761-platform,7.6.1 Platform>>
...
a| processingLevel  +
~$.properties.productInformation.processingLevel~        | eop:processingLevel    |   https://schema.org/additionalProperty[$.additionalProperty]   |    table_object_propertyvalue_additional_property
...
a| productType  +
~$..productInformation.productType~        | eop:productType    |    https://schema.org/additionalProperty[$.additionalProperty]   |    table_object_propertyvalue_additional_property
...
a| role +
~$.properties.qualifiedAttribution[*].role~       | dct:type |      https://schema.org/roleName[schema:roleName]        |    
...
a| acquisitionAngles +
~$..acquisitionParameters.acquisitionAngles~     | eop:acquisitionAngles      |    schema:acquisitionParameters/ schema:acquisitionAngles (Extension)         | <<764-acquisition-parameters,7.6.4 Acquisition Parameters>>

a| acquisitionInformation +
~$.properties.acquisitionInformation~     | eop:acquisitionInformation      |    schema:acquisitionInformation (Extension)         |  <<71-earth-observation,7.1 Earth Observation>>

a| AcquisitionInformation +
     | eop:AcquisitionInformation      |    schema:AcquisitionInformation (Extension)         |  <<76-acquisition-information,7.6 Acquisition Information>> 
     
a| acquisitionParameters +
~$..acquisitionInformation.acquisitionParameters~    | eop:acquisitionParameters   |    schema:acquisitionInformation/ schema:acquisitionparameters (Extension)  | <<76-acquisition-information,7.6 Acquisition Information>> 

a| AcquisitionParameters +
                                      | eop:AcquisitionParameters      |    schema:AcquisitionParameters (Extension)     |   <<76-acquisition-information,7.6 Acquisition Information>> 

a| acquisitionStation +
~$..acquisitionParameters.acquisitionStation~     | eop:acquisitionStation      |    schema:acquisitionParameters/ schema:acquisitionStation (Extension)         | <<764-acquisition-parameters,7.6.4 Acquisition Parameters>>



a| acquisitionSubType +
~$..acquisitionParameters.acquisitionSubType~     | eop:acquisitionSubType      |    schema:acquisitionParameters/ schema:acquisitionSubType (Extension)   | <<764-acquisition-parameters,7.6.4 Acquisition Parameters>>

a| acquisitionType +
~$..acquisitionParameters.acquisitionType~     | eop:acquisitionType      |    schema:acquisitionParameters/ schema:acquisitionType (Extension)   | <<764-acquisition-parameters,7.6.4 Acquisition Parameters>>


a| acrossTrackIncidenceAngle +
~$..acquisitionAngles.acrossTrackIncidenceAngle~    | eop:acrossTrackIncidenceAngle   |  schema:acquisitionInformation/ schema:acquisitionParameters/ schema:acquisitionAngles/ schema:acrossTrackIncidenceAngle (Extension)    |  <<765-acquisition-angles,7.6.5 Acquisition Angles>>

a| alongTrackIncidenceAngle +
~$..acquisitionAngles.alongTrackIncidenceAngle~    | eop:alongTrackIncidenceAngle   |  schema:acquisitionInformation/ schema:acquisitionParameters/ schema:acquisitionAngles/ schema:alongTrackIncidenceAngle (Extension)    | <<765-acquisition-angles,7.6.5 Acquisition Angles>>

a| antennaLookDirection +
~$..acquisitionParameters.antennaLookDirection~     | eop:antennaLookDirection     |    schema:acquisitionParameters/ schema:antennaLookDirection (Extension)         | <<764-acquisition-parameters,7.6.4 Acquisition Parameters>>

a| archivingCenter +
~$..productInformation.archivingCenter~     | eop:archivingCenter |     schema:productInformation/ https://schema.org/holdingArchive[schema:holdingArchive]      | <<77-product-information,7.7 Product Information>>

a| archivingDate +
~$..productInformation.archivingDate~     | eop:archivingDate |     schema:productInformation/ schema:archivingDate | <<77-product-information,7.7 Product Information>>

a| ascendingNodeDate +
~$..acquisitionParameters.ascendingNodeDate~      |  eop:ascendingNodeDate      |    schema:acquisitionInformation/  schema:acquisitionParameters/ schema:ascendingNodeDate (Extension) |  <<743-orbit-parameters,7.4.3 Orbit Parameters>>

a| ascendingNodeLongitude +
~$..acquisitionParameters.ascendingNodeLongitude~      |  eop:ascendingNodeLongitude      |    schema:acquisitionInformation/  schema:acquisitionParameters/ schema:ascendingNodeLongitude (Extension) |  <<743-orbit-parameters,7.4.3 Orbit Parameters>>

a| availabilityTime +
~$.properties.productInformation.availabilityTime~ |   eop:availabilityTime      |     schema:productInformation/ schema:availabilityTime (Extension) |  <<77-product-information,7.7 Product Information>>

a| available +
~$.properties.available~     | dct:available |     schema:available (Extension)     |   <<71-earth-observation,7.1 Earth Observation>>

a| bbox +
~$.bbox~     | gj:bbox      |    https://schema.org/spatialCoverage[schema:spatialCoverage]/ https://schema.org/geo[schema:geo]/ https://schema.org/box[schema:box]  |   <<table_object_geoshape>>

a| beginningDateTime +
~$..acquisitionParameters.beginningDateTime~     | dcat:startDate      |    https://schema.org/temporalCoverage[schema:temporalCoverage]         |   <<table_object_dates>>

a| cloudCover +
~$.properties.productInformation.cloudCover~     | eop:cloudCover      |    schema:productInformation/ schema:cloudCover  (Extension)       |  <<773-coverage-description,7.7.3 Coverage Description>>

a| completionTimeFromAscendingNode +
~$..acquisitionParameters.completion~ ~TimeFromAscendingNode~     | eop:completionTime FromAscendingNode      |    schema:acquisitionParameters/ schema:completionTime FromAscendingNode (Extension)         | <<764-acquisition-parameters,7.6.4 Acquisition Parameters>>

a| compositeType +
~$..productInformation.compositeType~     | eop:compositeType |   schema:productInformation/ schema:compositeType  (Extension)  |   <<772-processing-information,7.7.2 Processing Information>>

a| cycleNumber +
~$..acquisitionParameters.cycleNumber~     | eop:cycleNumber     |    schema:acquisitionParameters/ schema:cycleNumber (Extension)         | <<764-acquisition-parameters,7.6.4 Acquisition Parameters>>

a| description +
~$..instrument.description~    | dct:description   |  schema:acquisitionInformation/  schema:sensor/ https://schema.org/description[schema:description]  |  <<762-instrument,7.6.2 Instrument>>

a| discreteWavelengths +
~$..wavelengths[*].discreteWavelengths~     | eop:discreteWavelength      |     schema:acquisitionParameters/ schema:wavelengths/ https://schema.org/value[schema:value]   |  <<763-wavelength-information,7.6.3 Wavelength Information>>  

a| dopplerFrequency +
~$..acquisitionParameters.dopplerFrequency~     | eop:dopplerFrequency      |    schema:acquisitionInformation/ schema:acquisitionParameters/ schema:dopplerFrequency (Extension)         | <<764-acquisition-parameters,7.6.4 Acquisition Parameters>>

a| endingDateTime +
~$..acquisitionParameters.endingDateTime~     | dcat:endDate      |    https://schema.org/temporalCoverage[schema:temporalCoverage]    |   <<table_object_dates>>

a| endWavelength +
~$..wavelengths[*].endWavelength~     | eop:endWavelength      |     schema:acquisitionParameters/ schema:wavelengths/ https://schema.org/maxValue[schema:maxValue]        |  <<763-wavelength-information,7.6.3 Wavelength Information>>  (Extension)

a| format +
~$..productInformation.format~     | dct:format |   schema:productInformation/ https://schema.org/encodingFormat[schema:encodingFormat]  |   <<772-processing-information,7.7.2 Processing Information>>


a| geometry +
~$.geometry~   | gj:geometry  |    https://schema.org/geo[schema:geo]/ https://schema.org/spatialCoverage[schema:spatialCoverage]/ https://schema.org/geo[geo]      |   <<table_object_geoshape>>, https://schema.org/GeoShape[GeoShape] 

a| groundTrackUncertainty +
~$..acquisitionParameters.groundTrackUncertainty~     | eop:groundTrackUncertainty     |    schema:acquisitionParameters/ schema:groundTrackUncertainty (Extension)         | <<764-acquisition-parameters,7.6.4 Acquisition Parameters>>

a| highestLocation +
~$.properties.highestLocation~      |  eop:maximumAltitude      |    schema:acquisitionInformation/    schema:acquisitionParameters/ https://schema.org/location[schema:location]/  https://schema.org/maxValue[schema:maxValue] |  <<742-vertical-spatial-domain,7.4.2 Vertical Spatial Domain>>

a| identifier +
~$.properties.identifier~   | dct:identifier |          https://schema.org/identifier[schema:identifier] |  <<table_object_dataset>>


a| illuminationAzimuthAngle +
~$..acquisitionAngles.illumination~ ~AzimuthAngle~    | eop:illuminationAzimuthAngle   |  schema:acquisitionInformation/ schema:acquisitionParameters/ schema:acquisitionAngles/ schema:illuminationAzimuthAngle (Extension)    |  <<765-acquisition-angles,7.6.5 Acquisition Angles>>

a| illuminationElevationAngle +
~$..acquisitionAngles.illuminationv ~ElevationAngle~    | eop:illuminationElevationAngle   |  schema:acquisitionInformation/ schema:acquisitionParameters/ schema:acquisitionAngles/ schema:illuminationElevationAngle (Extension)    |  <<765-acquisition-angles,7.6.5 Acquisition Angles>>

a| illuminationZenithAngle +
~$..acquisitionAngles.illumination~ ~ZenithAngle~    | eop:instrumentZenithAngle   |  schema:acquisitionInformation/ schema:acquisitionParameters/ schema:acquisitionAngles/ schema:illuminationZenithAngle (Extension)    |  <<765-acquisition-angles,7.6.5 Acquisition Angles>>

a| incidenceAngle +
~$..acquisitionAngles.incidenceAngle~    | eop:incidenceAngle   |  schema:acquisitionInformation/ schema:acquisitionParameters/ schema:acquisitionAngles/ schema:incidenceAngle (Extension)    |  <<765-acquisition-angles,7.6.5 Acquisition Angles>>

a| incidenceAngleVariation +
~$..acquisitionAngles.incidenceAngleVariation~    | eop:incidenceAngleVariation   |  schema:acquisitionInformation/ schema:acquisitionParameters/ schema:acquisitionAngles/ schema:incidenceAngleVariation (Extension)    |  <<765-acquisition-angles,7.6.5 Acquisition Angles>>

a| instrument +
~$.acquisitionInformation[*].instrument~     | eop:instrument      |         schema:acquisitionInformation/ schema:sensor (Extension) |    <<76-acquisition-information,7.6 Acquisition Information>> (Extension)

a| Instrument  | eop:Instrument      |         schema:Instrument (Extension)   |   <<762-instrument,7.6.2 Instrument>>

a| instrumentShortName +
~$..instrument.instrumentShortName~    | eop:instrumentShortName   |  schema:acquisitionInformation/  schema:sensor/ https://schema.org/name[schema:name]  |  <<762-instrument,7.6.2 Instrument>>


a| instrumentAzimuthAngle +
~$..acquisitionAngles.instrument~ ~AzimuthAngle~    | eop:instrumentAzimuthAngle   |  schema:acquisitionInformation/ schema:acquisitionParameters/ schema:acquisitionAngles/ schema:instrumentAzimuthAngle (Extension)    |  <<765-acquisition-angles,7.6.5 Acquisition Angles>>

a| instrumentElevationAngle +
~$..acquisitionAngles.instrument~ ~ElevationAngle~    | eop:instrumentElevationAngle   |  schema:acquisitionInformation/ schema:acquisitionParameters/ schema:acquisitionAngles/ schema:instrumentElevationAngle (Extension)    |  <<765-acquisition-angles,7.6.5 Acquisition Angles>>

a| instrumentZenithAngle +
~$..acquisitionAngles.instrument~ ~ZenithAngle~    | eop:instrumentZenithAngle   |  schema:acquisitionInformation/ schema:acquisitionParameters/ schema:acquisitionAngles/ schema:instrumentZenithAngle (Extension)    |  <<765-acquisition-angles,7.6.5 Acquisition Angles>>

a| lastOrbitDirection +
~$..acquisitionParameters.lastOrbitDirection~      |  eop:lastOrbitDirection      |    schema:acquisitionInformation/  schema:acquisitionParameters/ schema:lastOrbitDirection (Extension) |  <<743-orbit-parameters,7.4.3 Orbit Parameters>>

a| lastOrbitNumber +
~$..acquisitionParameters.lastOrbitnumber~      |  eop:lastOrbitNumber      |    schema:acquisitionInformation/  schema:acquisitionParameters/ schema:lastOrbitNumber (Extension) |  <<743-orbit-parameters,7.4.3 Orbit Parameters>>

a| locationUnit +
~$.properties.lowestLocation~      |  eop:altitudeUnit      |    schema:acquisitionInformation/    schema:acquisitionParameters/ https://schema.org/location[schema:location]/ https://schema.org/unitText[schema:unitText] |  <<742-vertical-spatial-domain,7.4.2 Vertical Spatial Domain>>
...
a| lowestLocation +
~$.properties.lowestLocation~      |  eop:minimumAltitude      |    schema:acquisitionInformation/    schema:acquisitionParameters/ https://schema.org/location[schema:location]/  https://schema.org/minValue[schema:minValue] |  <<742-vertical-spatial-domain,7.4.2 Vertical Spatial Domain>>

a| measurementType +
~$..acquisitionParameters.measurementType~      |  eop:measurementType      |    schema:acquisitionInformation/  schema:acquisitionParameters/ schema:measurementType (Extension) |  <<764-acquisition-parameters,7.6.4 Acquisition Parameters>>

a| maximumIncidenceAngle +
~$..acquisitionAngles.maximumIncidenceAngle~    | eop:maximumIncidenceAngle   |  schema:acquisitionInformation/ schema:acquisitionParameters/ schema:acquisitionAngles/ schema:incidenceAngle/ https://schema.org/maxValue[schema:maxValue]     |  <<765-acquisition-angles,7.6.5 Acquisition Angles>>

a| minimumIncidenceAngle +
~$..acquisitionAngles.minimumIncidenceAngle~    | eop:minimumIncidenceAngle   |  schema:acquisitionInformation/ schema:acquisitionParameters/ schema:acquisitionAngles/ schema:incidenceAngle/ https://schema.org/minValue[schema:minValue]     |  <<765-acquisition-angles,7.6.5 Acquisition Angles>>

a| operationalMode +
~$..acquisitionParameters.operationalMode~     | eop:operationalMode      |    schema:acquisitionInformation/ schema:acquisitionParameters/ schema:operationalMode (Extension)         | <<764-acquisition-parameters,7.6.4 Acquisition Parameters>>

a| orbitDirection +
~$..acquisitionParameters.orbitDirection~      |  eop:orbitDirection      |    schema:acquisitionInformation/  schema:acquisitionParameters/ schema:orbitDirection (Extension) |  <<743-orbit-parameters,7.4.3 Orbit Parameters>>

a| orbitDuration +
~$..acquisitionParameters.orbitDuration~      |  eop:orbitDuration      |    schema:acquisitionInformation/  schema:acquisitionParameters/ schema:orbitDuration (Extension) |  <<743-orbit-parameters,7.4.3 Orbit Parameters>>

a| orbitNumber +
~$..acquisitionParameters.orbitnumber~      |  eop:orbitNumber      |    schema:acquisitionInformation/  schema:acquisitionParameters/ schema:orbitNumber (Extension) |  <<743-orbit-parameters,7.4.3 Orbit Parameters>>

a| orbitType +
~$..platform.orbitType~    | eop:orbitType   |  schema:acquisitionInformation/  schema:platform/ schema:orbitType (Extension)  |  <<761-platform,7.6.1 Platform>>

a| parentIdentifier +
~$.properties.parentIdentifier~     | eop:parentIdentifier |         https://schema.org/isPartOf[schema:isPartOf]   or schema:parentIdentifier (Extension)    |   <<71-earth-observation,7.1 Earth Observation>>

a| pitch +
~$..acquisitionAngles.pitch~    | eop:pitch   |  schema:acquisitionInformation/ schema:acquisitionParameters/ schema:acquisitionAngles/ schema:pitch (Extension)    | <<765-acquisition-angles,7.6.5 Acquisition Angles>>

a| platform +
~$.acquisitionInformation[*].platform~     | eop:platform      |    schema:acquisitionInformation/ schema:platform  (Extension)  |   <<76-acquisition-information,7.6 Acquisition Information>> 

a| Platform  | eop:Platform      |         schema:Platform (Extension)   |   <<761-platform,7.6.1 Platform>>

a| platformSerialIdentifier +
~$..platform.platformSerialIdentifier~    | eop:platformSerialIdentifier   |   schema:acquisitionInformation/ schema:platform/ https://schema.org/serialNumber[schema:serialNumber]    |  <<761-platform,7.6.1 Platform>>

a| platformShortName +
~$..platform.platformShortName~    | eop:platformShortName   |  schema:acquisitionInformation/  schema:platform/ https://schema.org/name[schema:name]  |  <<761-platform,7.6.1 Platform>>

a| polarisationChannels +
~$..acquisitionParameters.polarisationChannels~     | eop:polarisationChannels      |    schema:acquisitionParameters/ schema:polarisationChannels (Extension)         | <<764-acquisition-parameters,7.6.4 Acquisition Parameters>>

a| polarisationMode +
~$..acquisitionParameters.polarisationMode~     | eop:polarisationMode      |    schema:acquisitionParameters/ schema:polarisationMode (Extension)         | <<764-acquisition-parameters,7.6.4 Acquisition Parameters>>

a| processingCenter +
~$..productInformation.processingCenter~     | eop:processingCenter |   schema:productInformation/ schema:processingCenter  (Extension)  |   <<772-processing-information,7.7.2 Processing Information>>

a| processingDate +
~$..productInformation.processingDate~     | eop:processingDate |   schema:productInformation/ schema:processingDate  (Extension)  |   <<772-processing-information,7.7.2 Processing Information>>

a| processingLevel +
~$..productInformation.processingLevel~     | eop:processingLevel |   schema:productInformation/ schema:processingLevel  (Extension)  |   <<772-processing-information,7.7.2 Processing Information>>

a| processingMethod +
~$..productInformation.processingMethod~     | eop:processingMethod |   schema:productInformation/ schema:processingMethod  (Extension)  |   <<772-processing-information,7.7.2 Processing Information>>


a| processingMethodVersion +
~$..productInformation.processingMethodVersion~     | eop:processingMethodVersion |   schema:productInformation/ schema:processingMethodVersion  (Extension)  |   <<772-processing-information,7.7.2 Processing Information>>

a| processingMode +
~$..productInformation.processingMode~     | eop:processingMode |   schema:productInformation/ schema:processingMode  (Extension)  |   <<772-processing-information,7.7.2 Processing Information>>

a| processorName +
~$..productInformation.processorName~     | eop:processorName |   schema:productInformation/ schema:processorName  (Extension)  |   <<772-processing-information,7.7.2 Processing Information>>

a| processorVersion +
~$..productInformation.processorVersion~     | eop:processorVersion |   schema:productInformation/ https://schema.org/softwareVersion[schema:softwareVersion]  |   <<772-processing-information,7.7.2 Processing Information>>

a| productContentsType +
~$..productInformation.productContentsType~     | eop:productContentsType |   schema:productInformation/ schema:productContentsType  (Extension)  |   <<772-processing-information,7.7.2 Processing Information>>

a| timeliness +
~$.properties.productInformation.timeliness~ |   eop:timeliness      |     schema:productInformation/ schema:timeliness (Extension) |  <<77-product-information,7.7 Product Information>>

a| productGroupId +
~$..productInformation.productGroupId~     | eop:productGroupId |     https://schema.org/isPartOf[schema:isPartOf]     |   <<71-earth-observation,7.1 Earth Observation>>

a| productType +
~$..productInformation.productType~     | eop:productType |     schema:productInformation/ schema:productType (Extension)     | <<77-product-information,7.7 Product Information>>

a| productVersion +
~$..productInformation.productVersion~     | eop:productVersion |     schema:productInformation/ https://schema.org/version[schema:version]      | <<77-product-information,7.7 Product Information>>

a| qualityDegradation +
~$..qualityInformation.qualityDegradation~     | eop:qualityDegradation |     schema:productInformation/ schema:qualityInformation/ schema:qualityDegradation (Extension) | <<771-quality-information,7.7.1 Quality Information>>

a| qualityDegradation QuotationMode +
~$..qualityInformation.qualityDegradation~ ~QuotationMode~     | eop:qualityDegradation QuotationMode |     schema:productInformation/ schema:qualityInformation/ schema:qualityDegradation QuotationMode (Extension) | <<771-quality-information,7.7.1 Quality Information>>

a| qualityDegradationTag +
~$..qualityInformation.~ ~qualityDegradationTag~     | eop:qualityDegradationTag |     schema:productInformation/ schema:qualityInformation/ schema:qualityDegradationTag (Extension) | <<771-quality-information,7.7.1 Quality Information>>

a| qualityInformation +
~$..productInformation.qualityInformation~     | eop:qualityInformation |     schema:productInformation/ schema:qualityInformation (Extension) | <<77-product-information,7.7 Product Information>>

a| QualityInformation     | eop:QualityInformation |     schema:QualityInformation (Extension) | <<771-quality-information,7.7.1 Quality Information>>

a| qualityStatus +
~$..qualityInformation.qualityStatus~     | eop:qualityStatus |     schema:productInformation/ schema:qualityInformation/ schema:qualityStatus (Extension) | <<771-quality-information,7.7.1 Quality Information>>

a| referenceSystemIdentifier +
~$..productInformation.referenceSystemIdentifier~     | eop:referenceSystemIdentifier |     schema:productInformation/ https://schema.org/additionalProperty[schema:additionalProperty] | <<77-product-information,7.7 Product Information>>

a| relativeOrbitNumber +
~$..acquisitionParameters.~ ~relativeOrbitNumber~     | eop:relativeOrbitNumber      |    schema:acquisitionParameters/ schema:relativeOrbitNumber (Extension)         | <<764-acquisition-parameters,7.6.4 Acquisition Parameters>>

a| resolution +
~$..acquisitionParameters.resolution~     | eop:resolution      |    schema:acquisitionParameters/ schema:resolution (Extension)         | <<764-acquisition-parameters,7.6.4 Acquisition Parameters>>

a| roll +
~$..acquisitionAngles.roll~    | eop:roll   |  schema:acquisitionInformation/ schema:acquisitionParameters/ schema:acquisitionAngles/ schema:roll (Extension)    | <<765-acquisition-angles,7.6.5 Acquisition Angles>>


a| samplingRates +
~$..acquisitionParameters.samplingRates~     | eop:samplingRates     |    schema:acquisitionInformation/ schema:acquisitionParameters/ schema:samplingRate (Extension)   | <<764-acquisition-parameters,7.6.4 Acquisition Parameters>>

a| sensorType +
~$..instrument.sensorType~    | eop:sensorType   |  schema:acquisitionInformation/  schema:sensor/ schema:sensorType (Extension)  |  <<762-instrument,7.6.2 Instrument>>

a| snowCover +
~$.properties.productInformation.snowCover~     | eop:snowCover      |    schema:productInformation/ schema:snowCover  (Extension)       |  <<773-coverage-description,7.7.3 Coverage Description>>

a| size +
~$.properties.productInformation.size~ |   eop:size      |     schema:productInformation/ https://schema.org/contentSize[schema:contentSize]  |  <<77-product-information,7.7 Product Information>>

a| spectralRange +
~$..wavelengths[*].spectralRange~     | eop:spectralRange     |    schema:acquisitionParameters/ schema:wavelengths/ schema:spectralRange (Extension)   |  <<763-wavelength-information,7.6.3 Wavelength Information>>  
				      
a| startTimeFromAscendingNode +
~$..acquisitionParameters.startTimeFrom~ ~AscendingNode~     | eop:startTimeFrom AscendingNode      |    schema:acquisitionParameters/ schema:startTimeFromAscendingNode (Extension)         | <<764-acquisition-parameters,7.6.4 Acquisition Parameters>>

a| startWavelength +
~$..wavelengths[*].startWavelength~     | eop:startWavelength      |      schema:acquisitionParameters/ schema:wavelengths/ https://schema.org/minValue[schema:minValue]         |  <<763-wavelength-information,7.6.3 Wavelength Information>>  

a| status +
~$.properties.status~ |   eop:status      |      schema:acquisitionStatus (Extension) |  <<71-earth-observation,7.1 Earth Observation>>

a| statusDetail +
~$.properties.productInformation.statusDetail~ |   eop:statusDetail      |     schema:productInformation/ schema:statusDetail (Extension)  |  <<77-product-information,7.7 Product Information>>

a| statusSubType +
~$.properties.productInformation.statusSubType~ |   eop:statusSubType      |     schema:productInformation/ schema:statusSubType (Extension) |  <<77-product-information,7.7 Product Information>>
				      
a| swathIdentifier +
~$..acquisitionParameters.swathIdentifier~     | eop:swathIdentifier      |    schema:acquisitionParameters/ schema:swathIdentifier (Extension)         | <<764-acquisition-parameters,7.6.4 Acquisition Parameters>>

				      
a| tileId +
~$..acquisitionParameters.tileId~     | eop:tileId     |    schema:acquisitionParameters/ schema:tileId (Extension)         | <<764-acquisition-parameters,7.6.4 Acquisition Parameters>>

a| timeliness +
~$.properties.productInformation.timeliness~ |   eop:timeliness      |     schema:productInformation/ schema:timeliness (Extension) |  <<77-product-information,7.7 Product Information>>

a| verticalResolution +
~$..acquisitionParameters.verticalResolution~     | eop:verticalResolution      |    schema:acquisitionParameters/ schema:verticalResolution (Extension)         | <<764-acquisition-parameters,7.6.4 Acquisition Parameters>>

a| VerticalSpatialDomain     |   N/A      |      schema:VerticalSpatialDomain (Extension)   |  <<742-vertical-spatial-domain,7.4.2 Vertical Spatial Domain>>

a| WavelengthInformation     |   eop:WavelengthInformation      |      schema:WavelengthInformation      |     TBD (Extension)

a| wavelengths +
~$..acquisitionParameters.wavelengths~     | eop:wavelengths      |   schema:acquisitionParameters/ schema:wavelengths (Extension)   |  <<764-acquisition-parameters,7.6.4 Acquisition Parameters>>  (Extension)

a| wavelengthResolution +
~$..wavelengths[*].wavelengthResolution~     | eop:wavelengthResolution     |     schema:acquisitionParameters/ schema:wavelengths/ schema:wavelengthResolution (Extension)        |  <<763-wavelength-information,7.6.3 Wavelength Information>>  

a| wrsLatitudeGrid +
~$..acquisitionParameters.wrsLatitudeGrid~     | eop:wrsLatitudeGrid  |    schema:acquisitionParameters/ schema:wrsLatitudeGrid (Extension)         | <<764-acquisition-parameters,7.6.4 Acquisition Parameters>>

a| wrsLongitudeGrid +
~$..acquisitionParameters.wrsLongitudeGrid~     | eop:wrsLongitudeGrid     |    schema:acquisitionParameters/ schema:wrsLongitudeGrid (Extension)         | <<764-acquisition-parameters,7.6.4 Acquisition Parameters>>


a| yaw +
~$..acquisitionAngles.yaw~    | eop:yaw   |  schema:acquisitionInformation/ schema:acquisitionParameters/ schema:acquisitionAngles/ schema:yaw (Extension)    | <<765-acquisition-angles,7.6.5 Acquisition Angles>>
...
[cols=",,,",options="header",]
|===
|*STAC Property* | |*OGC 17-003r2 Property* | schema.org

|*https://github.com/radiantearth/stac-spec/blob/master/item-spec/item-spec.md#item-fields[Item
Fields]* | | |

|id | |$.properties.identifier |  https://schema.org/identifier[schema:identifier]

|collection | |$.properties.parentIdentifier | [schema:parentIdentifier] (extension) \| https://schema.org/isPartOf[schema:isPartOf]

| | | |

|*https://github.com/radiantearth/stac-spec/blob/master/item-spec/common-metadata.md[Common
Metadata]* | | |

|title |string |$.properties.title |  https://schema.org/name[schema:name]

|description |string |$.properties.abstract (See OGC 17-084r1) |  https://schema.org/description[schema:description]

|created |string |$.properties.creationDate | https://schema.org/dateCreated[schema:dateCreated]

|updated |string |$.properties.updated (metadata) |  https://schema.org/subjectOf[schema:subjectOf]/ https://schema.org/dateModified[schema:dateModified]

|links |[Link Object] |$.properties.links |

|assets.*.updated |string |$.properties.availabilityTime (data) |

|assets.* (role="data") |Asset Object |$.properties.links.data |  https://schema.org/distribution[schema:distribution]
 
|assets.* (role="thumbnail") |Asset Object |$.properties.links.previews |   https://schema.org/thumbnailUrl[schema:thumbnailUrl]

|assets.* (role="metadata") |Asset Object |$.properties.links.alternates |  https://schema.org/distribution[schema:distribution]

|datetime |string \| null |$.properties.date |  https://schema.org/temporalCoverage[schema:temporalCoverage]

|start_datetime |string   |$..acquisitionInformation[*]. acquisitionParameters.beginningDateTime | https://schema.org/temporalCoverage[schema:temporalCoverage]

|end_datetime |string     |$..acquisitionInformation[*]. acquisitionParameters.endingDateTime | https://schema.org/temporalCoverage[schema:temporalCoverage]

|providers |[Provider Object] |See OGC 17-084r1 |  https://schema.org/provider[schema:provider] and https://schema.org/Role[schema:Role]

|license |string |See OGC 17-084r1 |  https://schema.org/license[schema:license]
...
|*https://github.com/stac-extensions/eo[EO Extension]* | | |

|eo:cloud_cover |number |$.properties.productInformation.cloudCover | schema:productInformation/ schema:cloudCover (Extension)

|eo:bands |[Band Object] | |

| | | |

|*https://github.com/stac-extensions/sar[SAR Extension]* | | |

|sar:instrument_mode (M) |string    |$..acquisitionParameters.operationalMode |  schema:acquisitionParameters/ schema:operationalMode (Extension)

|sar:polarizations (M) |[string]    |$..acquisitionParameters.polarisationChannels |   schema:acquisitionParameters/ schema:polarisationChannels (Extension)

|sar:product_type (M) |string       |$.properties.productInformation.productType |  schema:productInformation/ schema:productType (Extension)

|sar:observation_direction |string   |$..acquisitionParameters.antennaLookDirection |  schema:acquisitionParameters/ schema:antennaLookDirection (Extension)

| | | |

|*https://github.com/stac-extensions/sat[SAT Extension]* | | |

|sat:orbit_state |string
|$.properties.acquisitionInformation[*]. acquisitionParameters.orbitDirection |  schema:acquisitionInformation/ schema:acquisitionParameters/ schema:lastOrbitDirection (Extension)

|sat:relative_orbit |integer    |$..acquisitionParameters.relativeOrbitNumber |  schema:acquisitionInformation/ schema:acquisitionParameters/ schema:relativeOrbitNumber (Extension)

| | | |

|*https://github.com/stac-extensions/scientific[Scientific Extension]* | | |

|sci:doi |string |$.properties.doi |   	https://schema.org/identifier[schema:identifier]/  https://schema.org/value[schema:value]

| | | |

|*https://github.com/stac-extensions/version[Version Extension]* | | |

|version |string |$properties.productInformation.version |   schema:productInformation/ https://schema.org/version[schema:version]

| | | |

|*https://github.com/stac-extensions/view[View Extension]* | | |

|view:off_nadir |number |$..acquisitionAngles.instrumentElevationAngle |  schema:instrumentElevationAngle (Extension)

|view:incidence_angle |number |$..acquisitionAngles.incidenceAngle | schema:incidenceAngle (Extension)

|view:azimuth |number |$..acquisitionAngles.instrumentAzimuthAngle |  schema:instrumentAzimuthAngle (Extension)

|view:sun_azimuth |number |$..acquisitionAngles.illuminationAzimuthAngle | schema:illuminationAzimuthAngle (Extension)

|view:sun_elevation |number |$..acquisitionAngles.illuminationElevationAngle | schema:illuminationElevationAngle (Extension)

| | | |

|*https://github.com/stac-extensions/projection[Projection Extension]* | | |

|proj:epsg (M) |integer
|$.properties.productInformation.referenceSystemIdentifier |   schema:productInformation/ https://schema.org/additionalProperty[schema:additionalProperty]

| | | |

|*https://github.com/stac-extensions/timestamps[Timestamps Extension]* | | |

|published |string |$.properties.published |  https://schema.org/datepublished[schema:datePublished]

| | | |

|*https://landsat.usgs.gov/stac/landsat-extension/schema.json[Landsat
Extension]* | | |

|landsat:wrs_path |string |$..acquisitionParameters.wrsLongitudeGrid |  schema:acquisitionParameters/ schema:wrsLongitudeGrid (Extension)

|landsat:wrs_row |string |$..acquisitionParameters.wrsLatitudeGrid |   schema:acquisitionParameters/ schema:wrsLatitudeGrid (Extension)

|landsat:scene_id |string | $..acquisitionParameters.tileId  |  schema:acquisitionParameters/ schema:tileId (Extension)
|===
...
The proposed extension to schema.org is included as <<appendix-f-schemaorg-extension-for-eo,Appendix F: Schema.org Extension for EO>>.
The additional classes and properties proposed are presented in <<7-eo-granules-encoding-extension, Chapter 7. EO Granules Encoding (Extension)>>.
...
|September 2, 2021 |Y. Coene | 0.3 |  - <<table_object_mediaobject>> (MediaObject) updated.  +
- <<appendix-c-property-mapping,Appendix C: Property Mapping>> updated. +
- publishingPrinciples added to encode $.conformsTo. +
- <<7-eo-granules-encoding-extension,Chapter 7. EO Granules Encoding (Extension)>> added with extension for EO granule encoding. +
- version of <<DCAT-AP-SDO>> updated | Updated version for EOVOC MTR.

|February 10, 2022 |Y. Coene | 0.4 |  - Added UseAction example representing WCS offering in new Related URL and Actions sections  +
for EO Service. +
- Added service to collection coupled resource encoding with `object` in <<541-action,§5.4.1>> +
- Added conformance encoding with `Review` in <<55-quality-information,§5.5>>
- Added SHACL information in <<appendix-b-interpretation-as-w3c-json-ld,Appendix B: Interpretation as W3C JSON-LD>> +
- Added SHACL shapes in various sections of the document. +
- Updated mapping table for OGC 17-003r2 properties.
- Updated mapping table for STAC Item properties.
- Included separate JSON-LD context file for EO extension in <<appendix-b-interpretation-as-w3c-json-ld,Appendix B: Interpretation as W3C JSON-LD>>. | Updated version for EOVOC PM-2 Meeting.
|July 29, 2022 |Y. Coene | 0.9 |  - Added GeoSPARQL section as <<453-geosparql,§4.5.3>> +
- <<CEOS-OS-BP>> reference updated. +
- Minor updates.   | Updated version for EOVOC FP milestone.
