...
a| instrument +
~$.acquisitionInformation[*].instrument~     | eop:instrument      |         schema:sensor (Extension) +
                                                                           [Domain: schema:AcquisitionInformation]  |    <<76-acquisition-information,7.6 Acquisition Information>> (Extension)
...
a| platform +
~$.acquisitionInformation[*].platform~     | eop:platform      |         schema:platform  +
                                                                    [Domain: schema:AcquisitionInformation]   |   <<76-acquisition-information,7.6 Acquisition Information>> (Extension)

a| Platform  | eop:Platform      |         schema:Platform (Extension)   |   <<761-platform,7.6.1 Platform>>

a| platformSerialIdentifier +
~$..platform.platformSerialIdentifier~    | eop:platformSerialIdentifier   |   https://schema.org/serialNumber[$.acquisitionInformation.platform.serialNumber]    |  <<76-acquisition-information,7.6 Acquisition Information>> (Extension)

a| platformShortName +
~$..platform.platformShortName~    | eop:platformShortName   |   https://schema.org/name +
                                                                [Domain: schema:Platform]   |  <<76-acquisition-information,7.6 Acquisition Information>> (Extension)
...
a| size +
~$.properties.productInformation.size~ |   eop:size      |     https://schema.org/contentSize +
                                      [Domain: schema:ProductInformation]  |     (Extension)
...
a| wavelengths +
~$..acquisitionParameters.wavelengths~     | eop:wavelengths      |     schema:wavelengths (Extension) +
                                                                      [Domain: schema:AcquisitionParameters]      |  <<764-acquisition-parameters,7.6.4 Acquisition Parameters>>  (Extension)
