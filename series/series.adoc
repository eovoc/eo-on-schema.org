...
a| productInformation +
~$.properties.productInformation~     | eop:productInformation |     schema:productInformation (Extension)     |   <<71-earth-observation,7.1 Earth Observation>>
...
a| size +
~$.properties.productInformation.size~ |   eop:size      |     schema:productInformation/ https://schema.org/contentSize[schema:contentSize]  |     (Extension)
